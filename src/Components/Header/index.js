...
// import Logo from '../Images/Indore.png';
    ...
    return (
      <div className="header-wrap">
        <div className="header-wrapper navbar-fixed-top">
          ...
          <Link to={{ pathname: `/` }}>
                  <span>
                    <img id="logo" src="https://previews.123rf.com/images/ratoca/ratoca1902/ratoca190200371/124996392-indore-city-of-india-love-message.jpg" alt="Indore" />
                  </span>
                </Link>
            <div className="nav">
